...
import { ChatModification, InitialReceivedChatsState, SocketConfig, WABusinessProfile, WAMediaUpload, WAPatchCreate, WAPatchName, WAPresence } from '../Types';
...
export declare const makeChatsSocket: (config: SocketConfig) => {
    ...
    resyncAppState: (collections: readonly WAPatchName[], recvChats: InitialReceivedChatsState | undefined) => Promise<import("../Types").AppStateChunk>;
