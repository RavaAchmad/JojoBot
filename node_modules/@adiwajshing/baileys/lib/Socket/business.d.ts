...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    resyncAppState: (collections: readonly ("critical_block" | "critical_unblock_low" | "regular_high" | "regular_low" | "regular")[], recvChats: import("../Types").InitialReceivedChatsState) => Promise<import("../Types").AppStateChunk>;
    chatModify: (mod: import("../Types").ChatModification, jid: string) => Promise<void>;
    resyncMainAppState: (ctx?: import("../Types").InitialReceivedChatsState) => Promise<void>;
