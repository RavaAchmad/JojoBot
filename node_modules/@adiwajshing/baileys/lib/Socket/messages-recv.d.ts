...
import { BaileysEventMap, InitialReceivedChatsState, MessageReceiptType, SocketConfig } from '../Types';
...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    resyncAppState: (collections: readonly ("critical_block" | "critical_unblock_low" | "regular_high" | "regular_low" | "regular")[], recvChats: InitialReceivedChatsState) => Promise<import("../Types").AppStateChunk>;
